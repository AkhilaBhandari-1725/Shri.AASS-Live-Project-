...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          ...
          <div class="col-lg-19">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4"><font color="purple"><b>About</b></font></h1>
              </div>
	...
	<br>
	<a href="about_disp.php"><input type="button" id="disprec" value="Display" class="btn btn-primary btn-user btn-block"></a>
              </form>	  
            </div>
          </div>
        </div>
