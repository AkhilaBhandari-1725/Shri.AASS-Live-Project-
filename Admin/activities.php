...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          ...
          <div class="col-lg-19">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4"><font color="purple"><b>Activities</b></font></h1>
              </div>
			  
              <form class="user" method="POST" id="uploadform"  enctype="multipart/form-data">
			  
				<div class="form-group">
				<input type="text" class="form-control form-control-user" id="a" name="a" placeholder="id"><br><br>
				</div>
				
				<div class="form-group">
				<input type="text" class="form-control form-control-user" id="a1" name="a1" placeholder="Title"><br><br>
				</div>
	...
	<br>
	<a href="activities_display.php"><input type="button" id="disprec" value="Display" class="btn btn-primary btn-user btn-block"></a>
              </form>	  
            </div>
          </div>
        </div>
