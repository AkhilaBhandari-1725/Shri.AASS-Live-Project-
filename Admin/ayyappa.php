...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          ...
          <div class="col-lg-19">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4"><font color="purple"><b>Ayyappa</b></font></h1>
              </div>
              ...
              <form class="user" method="POST" id="uploadform"  enctype="multipart/form-data">
				...
				<div class="form-group row">
                    <textarea  class="form-control form-control-user" id="a2" name="a2"  placeholder="Information"></textarea><br>
                </div>
	...
	<br>
	<a href="ayyappa_disp.php"><input type="button" id="disprec" value="Display" class="btn btn-primary btn-user btn-block"></a>
              </form>	  
            </div>
          </div>
        </div>
